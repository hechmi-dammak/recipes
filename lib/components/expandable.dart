...
/// modified widget from expandable package to add initialExpanded: true without controller
...
class ExpandableTheme extends StatelessWidget {
  ...
  const ExpandableTheme({required this.data, required this.child, super.key});
